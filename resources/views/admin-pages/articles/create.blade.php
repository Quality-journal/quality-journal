        ...
        <div>
            <form method="POST" action="#" class="p-10 bg-white rounded shadow-xl" enctype="multipart/form-data">
                ...
                <div class="mt-5">
                    ...
                    <textarea class="editor" id="authors" name="authors" required></textarea>
                </div>
                <div class="mt-5">
                ...
                <div class="mt-5">
                    ...
                    <textarea class="editor" id="abstract" name="abstract" required></textarea>
                </div>
                <div class="mt-5">
                ...
                <div class="mt-5">
                    ...
                    <textarea class="editor" id="reference" name="reference" required></textarea>
                </div>
                <div class="mt-6">
