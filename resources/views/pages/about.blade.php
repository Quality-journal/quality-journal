        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg py-5 p-5">
             ...
             <div class="flex flex-wrap py-4">
                ...
                <div class="w-3/4 sm:w-1/4 px-4 bg-gray-200 py-2 mt-3">
                    ...
                    <a href="/publishing-council" class="ml-5 p-2 hover:text-orange">Publishing council</a><br>
                    <a href="/ethics-and-policy" class="ml-5 p-2 hover:text-orange">Ethics and policy</a><br>
                </div>
