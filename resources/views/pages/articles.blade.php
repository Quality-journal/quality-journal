        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg py-5 p-5">
             ...
             <div class="flex flex-wrap py-4">
                ...
                <div class="w-full sm:w-3/4 px-8">
                    ...
                    <div class="flex py-4">
                        <img class="h-52" src="{{ asset('/storage/images/'.$currentIssue->image) }}" alt="{{ $currentIssue->title }}">
                        ...
                        @foreach($articles as $article)
                            <div class="px-4 w-full">
                                <div class="flex flex-wrap text-left border-b py-4">
                                    ...
                                    <a href="{{ asset('/storage/articles/'.$article->pdf) }}" target="_blank" class="text-lg px-4 py-3 mt-3 mr-4 bg-gray-200 hover:bg-orange hover:text-white">Download <i class="fas fa-download ml-2"></i> </a>
                                    <div>
