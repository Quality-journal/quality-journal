<x-guest-layout>
    ...
    <x-slot name="description">{{ 'Search the site, find articles, issues, volumes, Journal of Quality Engineering, IIPP' }}</x-slot>
    <x-slot name="keywords">{{ 'search, find, articles, issues, volumes, journal, quality, engineering, iipp' }}</x-slot>
    ...
    <div class="mx-auto sm:px-6 lg:px-8 pb-6 bg-white w-full flex flex-col overflow-x-hidden">
        ...
        <div class="text-gray-600 bg-white min-h-screen flex-col items-center justify-center mt-5">
            ...
            <div class="w-full sm:w-3/4 px-8 mt-3 border-2 mx-auto text-center border-solid border-gray-300 hover:border-yellow-500 hover:text-yellow-500">
                <a href="{{$res->url()}}">
