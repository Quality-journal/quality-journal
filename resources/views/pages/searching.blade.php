<x-guest-layout>
    ...
    <x-slot name="description">{{ 'find articles, issues, volumes, journal of quality engineering' }}</x-slot>
    <x-slot name="keywords">{{ 'find, articles, issues, volumes, search, journal, of, quality, engineering' }}</x-slot>
